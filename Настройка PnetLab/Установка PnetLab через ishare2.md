...
Так же быстренько устанавил утилиту `btop`, что бы показать загруженность на пустой ОС, ОС с PnetLab без лаб, ОС с PnetLab с простой лабой на 2 коммутатора
